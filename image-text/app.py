...
from transformers import pipeline #to download the huggingface model into local system
...
def text_to_speech(text):
    ...
    headers = {"Authorization": "Bearer {HUGGINGFACE_HUB_API_TOKEN}"}
    payload = {
        "inputs": text
    }
